<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="MealAdd.aspx.cs" Inherits="Admin_MealAdd" %>
                                ...
                                <div class="position-center">
                                    <form role="form">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TxtPrice" class="form-control" pattern="[0-9.]*" title="Please Enter Numeric Value..." runat="server"></asp:TextBox>
                                    </div>
