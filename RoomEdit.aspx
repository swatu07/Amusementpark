<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="RoomEdit.aspx.cs" Inherits="Admin_RoomAdd" %>
                    ...
                    <br />
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                     Image2
                                     <asp:Image ID="Image2" runat="server" Height="100" Width="100"></asp:Image>
                                     <br />Change
                                 <asp:FileUpload ID="FileUpload2" runat="server"></asp:FileUpload>
                                </div>
                                <div class="form-group">
                                     Image3
                                     <asp:Image ID="Image3" runat="server" Height="100" Width="100"></asp:Image>
                                     <br />Change
                                    <asp:FileUpload ID="FileUpload3" runat="server"></asp:FileUpload>
                                </div>
                                <div class="form-group">
                                     Image
                                     <asp:Image ID="Image4" runat="server" Height="100" Width="100"></asp:Image>
                                     <br />Change
