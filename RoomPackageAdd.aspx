<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="RoomPackageAdd.aspx.cs" Inherits="Admin_RoomPackageAdd" %>
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                     Max_Person
                                    <asp:TextBox ID="Max_Person" class="form-control" runat="server"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                     Image
