<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMasterPage.master" AutoEventWireup="true" CodeFile="RoomPackages.aspx.cs" Inherits="User_RoomPackages" %>
               ...
               <ItemTemplate>
								...
								<div class="col-md-3 w3_agileits_services_grid hvr-overline-from-center">
									...
									<div class="w3_agileits_services_grid_agile">
                                        ...
                                        <h4>Person  <b><u><%# Eval("Max_Person")%></u></b>  <h4>
                                        <h4>Meal Plan: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><u><%# Eval("MealName")%></u></b></h4>
                                        <h3>Amount: <%# Eval("Amount")%> <h3>
                                            <asp:Button ID="BtnBook" runat="server" Text="BOOK" CommandArgument='<%# Eval("RoomPackageID") %>' CommandName="BtnBook" />
									</div>
								</div>
